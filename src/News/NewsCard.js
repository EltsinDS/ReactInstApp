...
import NewsTrash from "./NewsTrash";

export default function NewsCard({card, updateNewsFeed}){
                    ...
                    <div className="row g-0">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                ...
                                <p className="card-text"><small className="text-muted">{card.date.toString()}</small></p>
                            </div>
                            <div className="d-dis">
                                ...
                                <NewsTrash id={card.id} updateNewsFeed={updateNewsFeed}/>
                            </div>
                        </div>
                    </div>
                </div>
